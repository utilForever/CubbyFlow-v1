...
#include <Core/Point/Implicit/AnisotropicPointsToImplicit2.h>

#include <random>

using namespace CubbyFlow;

CUBBYFLOW_TESTS(AnisotropicPointsToImplicit2);

CUBBYFLOW_BEGIN_TEST_F(AnisotropicPointsToImplicit2, ConvertTwo)
{
...
CUBBYFLOW_BEGIN_TEST_F(AnisotropicPointsToImplicit2, ConvertMany)
{
	Array1<Vector2D> points;
