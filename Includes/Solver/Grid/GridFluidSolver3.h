...
namespace CubbyFlow
{
	...
	//!
	class GridFluidSolver3::Builder final : public GridFluidSolverBuilderBase3<GridFluidSolver3::Builder>
	{
	public:
		...
		{
			return std::make_shared<GridFluidSolver3>(m_resolution, GetGridSpacing(), m_gridOrigin);
		}
	};
}
