/*************************************************************************
> File Name: PointParallelHashGridSearcher2.h
...
*************************************************************************/
#ifndef CUBBYFLOW_POINT_PARALLEL_HASH_GRID_SEARCHER2_H
#define CUBBYFLOW_POINT_PARALLEL_HASH_GRID_SEARCHER2_H
...
namespace CubbyFlow
{
	...
	//!
	//! \brief Front-end to create PointParallelHashGridSearcher2 objects step by step.
	//!
