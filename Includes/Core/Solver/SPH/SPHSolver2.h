...
*************************************************************************/
#ifndef CUBBYFLOW_SPH_SOLVER2_H
#define CUBBYFLOW_SPH_SOLVER2_H
...
namespace CubbyFlow
{
	...
	template <typename T>
	T& SPHSolverBuilderBase2<T>::WithRelativeKernelRadius(double relativeKernelRadius)
	{
