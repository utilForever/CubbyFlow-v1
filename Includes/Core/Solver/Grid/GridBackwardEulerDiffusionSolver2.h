/*************************************************************************
> File Name: GridBackwardEulerDiffusionSolver2.h
...
namespace CubbyFlow
{
	...
	public:
		...
		explicit GridBackwardEulerDiffusionSolver2(BoundaryType boundaryType = BoundaryType::Neumann);
		...
		void Solve(
			...
			const ScalarField2& fluidSDF = ConstantScalarField2(-std::numeric_limits<double>::max())) override;
