/*************************************************************************
> File Name: ScalarGrid2.cpp
> Project Name: CubbyFlow
> Author: Chan-Ho Chris Ohk
> Purpose: Abstract base class for 2-D scalar grid structure.
...
namespace CubbyFlow
{
	...
	void ScalarGrid2::Serialize(std::vector<uint8_t>* buffer) const
	{
		...
		auto fbsGrid = fbs::CreateScalarGrid2(builder, &fbsResolution, &fbsGridSpacing, &fbsOrigin, data);
