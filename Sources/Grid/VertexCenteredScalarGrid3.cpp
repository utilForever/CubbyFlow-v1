/*************************************************************************
> File Name: VertexCenteredScalarGrid3.cpp
...
namespace CubbyFlow
{
	...
	VertexCenteredScalarGrid3::VertexCenteredScalarGrid3(const VertexCenteredScalarGrid3& other)
	{
		Set(other);
	}
	...
	std::shared_ptr<ScalarGrid3> VertexCenteredScalarGrid3::Clone() const
	{
		return std::shared_ptr<VertexCenteredScalarGrid3>(
			new VertexCenteredScalarGrid3(*this), [](VertexCenteredScalarGrid3* obj)
		{
			delete obj;
		});
	}
	...
	VertexCenteredScalarGrid3::Builder& VertexCenteredScalarGrid3::Builder::WithResolution(size_t resolutionX, size_t resolutionY, size_t resolutionZ)
	{
	...
	VertexCenteredScalarGrid3::Builder& VertexCenteredScalarGrid3::Builder::WithGridSpacing(double gridSpacingX, double gridSpacingY, double gridSpacingZ)
	{
	...
	VertexCenteredScalarGrid3::Builder& VertexCenteredScalarGrid3::Builder::WithOrigin(double gridOriginX, double gridOriginY, double gridOriginZ)
	{
