/*************************************************************************
> File Name: VertexCenteredScalarGrid2.cpp
> Project Name: CubbyFlow
> Author: Chan-Ho Chris Ohk
> Purpose: 2-D Vertex-centered scalar grid structure.
...
namespace CubbyFlow
{
	...
	VertexCenteredScalarGrid2::VertexCenteredScalarGrid2(const VertexCenteredScalarGrid2& other)
	{
		Set(other);
	}
	...
	std::shared_ptr<ScalarGrid2> VertexCenteredScalarGrid2::Clone() const
	{
		return std::shared_ptr<VertexCenteredScalarGrid2>(
			new VertexCenteredScalarGrid2(*this), [](VertexCenteredScalarGrid2* obj)
		{
			delete obj;
		});
	}
	...
	VertexCenteredScalarGrid2::Builder& VertexCenteredScalarGrid2::Builder::WithResolution(size_t resolutionX, size_t resolutionY)
	{
	...
	VertexCenteredScalarGrid2::Builder& VertexCenteredScalarGrid2::Builder::WithGridSpacing(double gridSpacingX, double gridSpacingY)
	{
	...
	VertexCenteredScalarGrid2::Builder& VertexCenteredScalarGrid2::Builder::WithOrigin(const Vector2D& gridOrigin)
	{
		m_gridOrigin = gridOrigin;	
		return *this;
	}

	VertexCenteredScalarGrid2::Builder& VertexCenteredScalarGrid2::Builder::WithOrigin(double gridOriginX, double gridOriginY)
	{
	...
	{
		return VertexCenteredScalarGrid2(m_resolution, m_gridSpacing, m_gridOrigin, m_initialVal);
	}

	VertexCenteredScalarGrid2Ptr VertexCenteredScalarGrid2::Builder::MakeShared() const
	{
		return std::shared_ptr<VertexCenteredScalarGrid2>(
			new VertexCenteredScalarGrid2(m_resolution, m_gridSpacing, m_gridOrigin, m_initialVal),
