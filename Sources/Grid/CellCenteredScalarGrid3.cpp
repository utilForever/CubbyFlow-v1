...
namespace CubbyFlow
{
	...
	std::shared_ptr<ScalarGrid3> CellCenteredScalarGrid3::Clone() const
	{
		return std::shared_ptr<CellCenteredScalarGrid3>(
			new CellCenteredScalarGrid3(*this), [](CellCenteredScalarGrid3* obj)
		{
			delete obj;
		});
	}
	...
	CellCenteredScalarGrid3::Builder& CellCenteredScalarGrid3::Builder::WithResolution(size_t resolutionX, size_t resolutionY, size_t resolutionZ)
	{
	...
	CellCenteredScalarGrid3::Builder& CellCenteredScalarGrid3::Builder::WithGridSpacing(double gridSpacingX, double gridSpacingY, double gridSpacingZ)
	{
	...
	CellCenteredScalarGrid3::Builder& CellCenteredScalarGrid3::Builder::WithOrigin(const Vector3D& gridOrigin)
	{
		m_gridOrigin = gridOrigin;
		return *this;
	}

	CellCenteredScalarGrid3::Builder& CellCenteredScalarGrid3::Builder::WithOrigin(double gridOriginX, double gridOriginY, double gridOriginZ)
	{
	...
	{
		return CellCenteredScalarGrid3(m_resolution, m_gridSpacing, m_gridOrigin, m_initialVal);
	}

	CellCenteredScalarGrid3Ptr CellCenteredScalarGrid3::Builder::MakeShared() const
	{
		return std::shared_ptr<CellCenteredScalarGrid3>(
			new CellCenteredScalarGrid3(m_resolution, m_gridSpacing, m_gridOrigin, m_initialVal),
