/*************************************************************************
> File Name: LevelSetLiquidSolver2.cpp
...
namespace CubbyFlow
{
		...
		GridFluidSolver2(resolution, gridSpacing, gridOrigin)
	{
		...
		m_signedDistanceFieldId = grids->AddAdvectableScalarData(std::make_shared<CellCenteredScalarGrid2::Builder>(), std::numeric_limits<double>::max());
	...
	void LevelSetLiquidSolver2::SetLevelSetSolver(const LevelSetSolver2Ptr& newSolver)
	{
