...
namespace CubbyFlow
{
	...
	Sphere2::Sphere2(const Vector2D& center_, double radius_, const Transform2& transform_, bool isNormalFlipped_) :
	...
	{
		return std::shared_ptr<Sphere2>(new Sphere2(m_center, m_radius, m_transform, m_isNormalFlipped),
			[](Sphere2* obj)
		{
			delete obj;
		});
