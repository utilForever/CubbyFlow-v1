...
*************************************************************************/
#ifndef CUBBYFLOW_BVH3_IMPL_H
#define CUBBYFLOW_BVH3_IMPL_H
...
namespace CubbyFlow
{
	...
	template <typename T>
	inline bool BVH3<T>::IsIntersects(const BoundingBox3D& box,
	...
	template <typename T>
	inline bool BVH3<T>::IsIntersects(const Ray3D& ray,
