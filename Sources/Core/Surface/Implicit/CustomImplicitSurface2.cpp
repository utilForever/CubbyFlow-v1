/*************************************************************************
> File Name: CustomImplicitSurface2.cpp
...
namespace CubbyFlow
{
	CustomImplicitSurface2::CustomImplicitSurface2(
		const std::function<double(const Vector2D&)>& func, const BoundingBox2D& domain, double resolution,
	...
	{
		BoundingBoxRayIntersection2D intersection = m_domain.ClosestIntersection(ray);
	...
	{
		return CustomImplicitSurface2(m_func, m_domain, m_resolution, m_rayMarchingResolution, m_maxNumberOfIterations, m_transform, m_isNormalFlipped);
	}

	CustomImplicitSurface2Ptr CustomImplicitSurface2::Builder::MakeShared() const
	{
		return std::shared_ptr<CustomImplicitSurface2>(
			new CustomImplicitSurface2(m_func, m_domain, m_resolution, m_rayMarchingResolution, m_maxNumberOfIterations, m_transform, m_isNormalFlipped),
