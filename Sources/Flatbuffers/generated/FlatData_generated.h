...
inline const CubbyFlow::fbs::FlatData *GetFlatData(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::FlatData>(buf);
}

inline bool VerifyFlatDataBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::FlatData>(nullptr);
}

inline void FinishFlatDataBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::FlatData> root) {
  fbb.Finish(root);
}
