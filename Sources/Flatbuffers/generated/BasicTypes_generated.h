...
MANUALLY_ALIGNED_STRUCT(8) Size2 FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Size2() { memset(this, 0, sizeof(Size2)); }
  Size2(const Size2 &_o) { memcpy(this, &_o, sizeof(Size2)); }
...
MANUALLY_ALIGNED_STRUCT(8) Size3 FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Size3() { memset(this, 0, sizeof(Size3)); }
  Size3(const Size3 &_o) { memcpy(this, &_o, sizeof(Size3)); }
...
MANUALLY_ALIGNED_STRUCT(8) Vector2D FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Vector2D() { memset(this, 0, sizeof(Vector2D)); }
  Vector2D(const Vector2D &_o) { memcpy(this, &_o, sizeof(Vector2D)); }
...
MANUALLY_ALIGNED_STRUCT(8) Vector3D FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Vector3D() { memset(this, 0, sizeof(Vector3D)); }
  Vector3D(const Vector3D &_o) { memcpy(this, &_o, sizeof(Vector3D)); }
