...
#ifndef FLATBUFFERS_GENERATED_POINTSIMPLELISTSEARCHER3_CubbyFlow_fbs_H_
#define FLATBUFFERS_GENERATED_POINTSIMPLELISTSEARCHER3_CubbyFlow_fbs_H_
...
struct PointSimpleListSearcher3Builder {
  ...
  void add_Points(flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *>> points) { fbb_.AddOffset(PointSimpleListSearcher3::VT_POINTS, points); }
...
inline flatbuffers::Offset<PointSimpleListSearcher3> CreatePointSimpleListSearcher3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreatePointSimpleListSearcher3(_fbb, points ? _fbb.CreateVector<const CubbyFlow::fbs::Vector3D *>(*points) : 0);
}

inline const CubbyFlow::fbs::PointSimpleListSearcher3 *GetPointSimpleListSearcher3(const void *buf) { return flatbuffers::GetRoot<CubbyFlow::fbs::PointSimpleListSearcher3>(buf); }

inline bool VerifyPointSimpleListSearcher3Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<CubbyFlow::fbs::PointSimpleListSearcher3>(nullptr); }

inline void FinishPointSimpleListSearcher3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<CubbyFlow::fbs::PointSimpleListSearcher3> root) { fbb.Finish(root); }

}  // namespace fbs
}  // namespace CubbyFlow

#endif  // FLATBUFFERS_GENERATED_POINTSIMPLELISTSEARCHER3_CubbyFlow_fbs_H_
