...
void AddVector2F(pybind11::module& m)
{
	pybind11::class_<Vector2F>(static_cast<pybind11::handle>(m), "Vector2F")
		.def("__init__", [](Vector2F& instance, float x, float y)
	{
		...
		.def("Dot", [](const Vector2F& instance, pybind11::object other)
	{
		return instance.Dot(ObjectToVector2F(other));
	})
		.def("Cross", [](const Vector2F& instance, pybind11::object other)
	{
		...
		.def("DistanceTo", [](const Vector2F& instance, pybind11::object other)
	{
		return instance.DistanceTo(ObjectToVector2F(other));
	})
		.def("DistanceSquaredTo", [](const Vector2F& instance, pybind11::object other)
	{
		return instance.DistanceSquaredTo(ObjectToVector2F(other));
	})
		.def("Reflected", [](const Vector2F& instance, pybind11::object other)
	{
		return instance.Reflected(ObjectToVector2F(other));
	})
		.def("Projected", [](const Vector2F& instance, pybind11::object other)
	{
		return instance.Projected(ObjectToVector2F(other));
	})
		.def("Tangential", &Vector2F::Tangential)
		.def("__getitem__", [](const Vector2F& instance, size_t i) -> float { return instance[i]; })
		.def("__setitem__", [](Vector2F& instance, size_t i, float val) { instance[i] = val; })
		.def("__add__", [](const Vector2F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__sub__", [](const Vector2F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__rsub__", [](const Vector2F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__mul__", [](const Vector2F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__truediv__", [](const Vector2F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__rtruediv__", [](const Vector2F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
...
void AddVector2D(pybind11::module& m)
{
	pybind11::class_<Vector2D>(static_cast<pybind11::handle>(m), "Vector2D")
		.def("__init__", [](Vector2D& instance, double x, double y)
	{
		...
		.def("Dot", [](const Vector2D& instance, pybind11::object other)
	{
		return instance.Dot(ObjectToVector2D(other));
	})
		.def("Cross", [](const Vector2D& instance, pybind11::object other)
	{
		...
		.def("DistanceTo", [](const Vector2D& instance, pybind11::object other)
	{
		return instance.DistanceTo(ObjectToVector2D(other));
	})
		.def("DistanceSquaredTo", [](const Vector2D& instance, pybind11::object other)
	{
		return instance.DistanceSquaredTo(ObjectToVector2D(other));
	})
		.def("Reflected", [](const Vector2D& instance, pybind11::object other)
	{
		return instance.Reflected(ObjectToVector2D(other));
	})
		.def("Projected", [](const Vector2D& instance, pybind11::object other)
	{
		return instance.Projected(ObjectToVector2D(other));
	})
		.def("Tangential", &Vector2D::Tangential)
		.def("__getitem__", [](const Vector2D& instance, size_t i) -> double { return instance[i]; })
		.def("__setitem__", [](Vector2D& instance, size_t i, double val) { instance[i] = val; })
		.def("__add__", [](const Vector2D& instance, pybind11::object object)
	{
		...
		.def("__sub__", [](const Vector2D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__rsub__", [](const Vector2D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__mul__", [](const Vector2D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
		...
		.def("__truediv__", [](const Vector2D& instance, pybind11::object object)
	{
		...
		.def("__rtruediv__", [](const Vector2D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
...
void AddVector3F(pybind11::module& m)
{
	pybind11::class_<Vector3F>(static_cast<pybind11::handle>(m), "Vector3F")
		.def("__init__", [](Vector3F& instance, float x, float y, float z)
	{
		...
		.def("Dot", [](const Vector3F& instance, pybind11::object other)
	{
		return instance.Dot(ObjectToVector3F(other));
	})
		.def("Cross", [](const Vector3F& instance, pybind11::object other)
	{
		...
		.def("DistanceTo", [](const Vector3F& instance, pybind11::object other)
	{
		return instance.DistanceTo(ObjectToVector3F(other));
	})
		.def("DistanceSquaredTo", [](const Vector3F& instance, pybind11::object other)
	{
		return instance.DistanceSquaredTo(ObjectToVector3F(other));
	})
		.def("Reflected", [](const Vector3F& instance, pybind11::object other)
	{
		return instance.Reflected(ObjectToVector3F(other));
	})
		.def("Projected", [](const Vector3F& instance, pybind11::object other)
	{
		return instance.Projected(ObjectToVector3F(other));
	})
		.def("Tangential", &Vector3F::Tangential)
		.def("__getitem__", [](const Vector3F& instance, size_t i) -> float { return instance[i]; })
		.def("__setitem__", [](Vector3F& instance, size_t i, float val) { instance[i] = val; })
		.def("__add__", [](const Vector3F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
			return instance.Add(object.cast<float>());
		...
		.def("__sub__", [](const Vector3F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
			return instance.Sub(object.cast<float>());
		...
		.def("__rsub__", [](const Vector3F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
			return instance.RSub(object.cast<float>());
		...
		.def("__mul__", [](const Vector3F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
			return instance.Mul(object.cast<float>());
		...
		.def("__truediv__", [](const Vector3F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
			return instance.Div(object.cast<float>());
		...
		.def("__rtruediv__", [](const Vector3F& instance, pybind11::object object)
	{
		if (pybind11::isinstance<float>(static_cast<pybind11::handle>(object)))
		{
			return instance.RDiv(object.cast<float>());
...
void AddVector3D(pybind11::module& m)
{
	pybind11::class_<Vector3D>(static_cast<pybind11::handle>(m), "Vector3D")
		.def("__init__", [](Vector3D& instance, double x, double y, double z)
	{
		...
		.def("Dot", [](const Vector3D& instance, pybind11::object other)
	{
		return instance.Dot(ObjectToVector3D(other));
	})
		.def("Cross", [](const Vector3D& instance, pybind11::object other)
	{
		...
		.def("DistanceTo", [](const Vector3D& instance, pybind11::object other)
	{
		return instance.DistanceTo(ObjectToVector3D(other));
	})
		.def("DistanceSquaredTo", [](const Vector3D& instance, pybind11::object other)
	{
		return instance.DistanceSquaredTo(ObjectToVector3D(other));
	})
		.def("Reflected", [](const Vector3D& instance, pybind11::object other)
	{
		return instance.Reflected(ObjectToVector3D(other));
	})
		.def("Projected", [](const Vector3D& instance, pybind11::object other)
	{
		return instance.Projected(ObjectToVector3D(other));
	})
		.def("Tangential", &Vector3D::Tangential)
		.def("__getitem__", [](const Vector3D& instance, size_t i) -> double { return instance[i]; })
		.def("__setitem__", [](Vector3D& instance, size_t i, double val) { instance[i] = val; })
		.def("__add__", [](const Vector3D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
			return instance.Add(object.cast<double>());
		...
		.def("__sub__", [](const Vector3D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
			return instance.Sub(object.cast<double>());
		...
		.def("__rsub__", [](const Vector3D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
			return instance.RSub(object.cast<double>());
		...
		.def("__mul__", [](const Vector3D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
			return instance.Mul(object.cast<double>());
		...
		.def("__truediv__", [](const Vector3D& instance, pybind11::object object)
	{
		...
		.def("__rtruediv__", [](const Vector3D& instance, pybind11::object object)
	{
		if (pybind11::isinstance<double>(static_cast<pybind11::handle>(object)))
		{
			return instance.RDiv(object.cast<double>());
