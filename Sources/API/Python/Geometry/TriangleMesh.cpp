...
{
	pybind11::class_<TriangleMesh3, TriangleMesh3Ptr, Surface3>(static_cast<pybind11::handle>(m), "TriangleMesh3",
		R"pbdoc(
	...
	.def("__init__", [](TriangleMesh3& instance, pybind11::list points, pybind11::list normals,
				pybind11::list uvs, pybind11::list pointIndices, pybind11::list normalIndices,
				pybind11::list uvIndices, const Transform3& transform, bool isNormalFlipped)
	{
		...
		new (&instance) TriangleMesh3(points_, normals_, uvs_, pointIndices_, normalIndices_, uvIndices_, transform, isNormalFlipped);
	},
		R"pbdoc(
	...
	.def("Point", [](const TriangleMesh3& instance, size_t i) -> Vector3D
	{
		...
		pybind11::arg("i"))
	.def("SetPoint", [](TriangleMesh3& instance, size_t i, const Vector3D& pt)
	{
		instance.Point(i) = pt;
	},
		R"pbdoc(
	...
	.def("Normal", [](const TriangleMesh3& instance, size_t i) -> Vector3D
	{
		...
		pybind11::arg("i"))
	.def("SetNormal", [](TriangleMesh3& instance, size_t i, const Vector3D& n)
	{
		instance.Normal(i) = n;
	},
		R"pbdoc(
	...
	.def("PointIndex", [](const TriangleMesh3& instance, size_t i) -> Point3UI
	{
		...
		pybind11::arg("i"))
	.def("SetPointIndex", [](TriangleMesh3& instance, size_t i, const Point3UI& idx)
	{
	...
	.def("UVIndex", [](const TriangleMesh3& instance, size_t i) -> Point3UI
	{
		...
		pybind11::arg("i"))
	.def("SetUVIndex", [](TriangleMesh3& instance, size_t i, const Point3UI& idx)
	{
		...
		pybind11::arg("i"),
		pybind11::arg("idx"))
	.def("Triangle", [](const TriangleMesh3& instance, size_t i)
	{
	...
	.def("AddPoint", [](TriangleMesh3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("pt"))
	.def("AddNormal", [](TriangleMesh3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("n"))
	.def("AddUV", [](TriangleMesh3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("uv"))
	.def("AddPointTriangle", [](TriangleMesh3& instance, pybind11::object obj)
	{
	...
	.def("AddPointNormalTriangle", [](TriangleMesh3& instance, pybind11::object obj1, pybind11::object obj2)
	{
		instance.AddPointNormalTriangle(ObjectToPoint3UI(obj1), ObjectToPoint3UI(obj2));
	},
		R"pbdoc(
	...
	.def("AddPointUVNormalTriangle", [](TriangleMesh3& instance, pybind11::object obj1, pybind11::object obj2, pybind11::object obj3)
	{
		instance.AddPointUVNormalTriangle(ObjectToPoint3UI(obj1), ObjectToPoint3UI(obj2), ObjectToPoint3UI(obj3));
	},
		R"pbdoc(
		...
		pybind11::arg("newNormalIndices"))
	.def("AddPointUVTriangle", [](TriangleMesh3& instance, pybind11::object obj1, pybind11::object obj2)
	{
		instance.AddPointUVTriangle(ObjectToPoint3UI(obj1), ObjectToPoint3UI(obj2));
	},
		R"pbdoc(
	...
	.def("SetAngleWeightedVertexNormal", &TriangleMesh3::SetAngleWeightedVertexNormal,
		R"pbdoc(
	...
	.def("Scale", &TriangleMesh3::Scale,
		...
		pybind11::arg("factor"))
	.def("Translate", [](TriangleMesh3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("t"))
	.def("Rotate", [](TriangleMesh3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("rot"))
	.def("WriteObj", [](const TriangleMesh3& instance, const std::string& fileName)
	{
	...
	.def("ReadObj", [](TriangleMesh3& instance, const std::string& fileName) 
	{
