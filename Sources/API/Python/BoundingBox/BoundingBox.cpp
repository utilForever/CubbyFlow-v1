...
{
	pybind11::class_<BoundingBoxRayIntersection2F>(static_cast<pybind11::handle>(m), "BoundingBoxRayIntersection2F",
		R"pbdoc(
			2-D box-ray intersection result (32-bit float).
		)pbdoc")
	.def_readwrite("isIntersecting", &BoundingBoxRayIntersection2F::isIntersecting,
		R"pbdoc(
	...
	pybind11::class_<BoundingBox2F>(static_cast<pybind11::handle>(m), "BoundingBox2F",
		R"pbdoc(
			2-D axis-aligned bounding box class (32-bit float).
		)pbdoc")
	.def("__init__", [](BoundingBox2F& instance, pybind11::args args)
	{
		if (args.size() == 2)
		{
			new (&instance) BoundingBox2F(ObjectToVector2F(args[0]), ObjectToVector2F(args[1]));
		}
		else if (args.size() == 0)
		{
	...
	.def("Overlaps", &BoundingBox2F::Overlaps,
		...
		pybind11::arg("other"))
	.def("Contains", [](const BoundingBox2F& instance, pybind11::object point)
	{
	...
	.def("Merge", [](BoundingBox2F& instance, pybind11::object other)
	{
		if (pybind11::isinstance<pybind11::tuple>(static_cast<pybind11::handle>(other)) ||
			pybind11::isinstance<Vector2F>(static_cast<pybind11::handle>(other)))
		{
			instance.Merge(ObjectToVector2F(other));
		}
		else if (pybind11::isinstance<BoundingBox2F>(static_cast<pybind11::handle>(other)))
		{
			instance.Merge(other.cast<BoundingBox2F>());
		}
		else
		{
			throw std::invalid_argument("Incompatible argument type for merge.");
		}
	},
		R"pbdoc(
...
{
	pybind11::class_<BoundingBoxRayIntersection2D>(static_cast<pybind11::handle>(m), "BoundingBoxRayIntersection2D",
		R"pbdoc(
			2-D box-ray intersection result (64-bit float).
		)pbdoc")
	.def_readwrite("isIntersecting", &BoundingBoxRayIntersection2D::isIntersecting,
		R"pbdoc(
			True if the box and ray intersects.
		)pbdoc")
	...
	pybind11::class_<BoundingBox2D>(static_cast<pybind11::handle>(m), "BoundingBox2D",
		R"pbdoc(
			2-D axis-aligned bounding box class (64-bit float).
		)pbdoc")
	.def("__init__", [](BoundingBox2D& instance, pybind11::args args)
	{
		if (args.size() == 2)
		{
			new (&instance) BoundingBox2D(ObjectToVector2D(args[0]), ObjectToVector2D(args[1]));
		}
		else if (args.size() == 0)
		{
	...
	.def("Overlaps", &BoundingBox2D::Overlaps,
		...
		pybind11::arg("other"))
	.def("Contains", [](const BoundingBox2D& instance, pybind11::object point)
	{
	...
	.def("Merge", [](BoundingBox2D& instance, pybind11::object other)
	{
		if (pybind11::isinstance<pybind11::tuple>(static_cast<pybind11::handle>(other)) ||
			pybind11::isinstance<Vector2D>(static_cast<pybind11::handle>(other)))
		{
			instance.Merge(ObjectToVector2D(other));
		}
		else if (pybind11::isinstance<BoundingBox2D>(static_cast<pybind11::handle>(other)))
		{
...
{
	pybind11::class_<BoundingBoxRayIntersection3F>(static_cast<pybind11::handle>(m), "BoundingBoxRayIntersection3F",
		R"pbdoc(
			3-D box-ray intersection result (32-bit float).
		)pbdoc")
	.def_readwrite("isIntersecting", &BoundingBoxRayIntersection3F::isIntersecting,
		R"pbdoc(
			True if the box and ray intersects.
		)pbdoc")
	...
	pybind11::class_<BoundingBox3F>(static_cast<pybind11::handle>(m), "BoundingBox3F",
		R"pbdoc(
			3-D axis-aligned bounding box class (32-bit float).
		)pbdoc")
	.def("__init__", [](BoundingBox3F& instance, pybind11::args args)
	{
		if (args.size() == 2)
		{
			new (&instance) BoundingBox3F(ObjectToVector3F(args[0]), ObjectToVector3F(args[1]));
		}
		else if (args.size() == 0)
		{
	...
	.def("Overlaps", &BoundingBox3F::Overlaps,
		...
		pybind11::arg("other"))
	.def("Contains", [](const BoundingBox3F& instance, pybind11::object point)
	{
	...
	.def("Merge", [](BoundingBox3F& instance, pybind11::object other)
	{
		if (pybind11::isinstance<pybind11::tuple>(static_cast<pybind11::handle>(other)) ||
			pybind11::isinstance<Vector3F>(static_cast<pybind11::handle>(other)))
		{
			instance.Merge(ObjectToVector3F(other));
		}
		else if (pybind11::isinstance<BoundingBox3F>(static_cast<pybind11::handle>(other)))
		{
...
{
	pybind11::class_<BoundingBoxRayIntersection3D>(static_cast<pybind11::handle>(m), "BoundingBoxRayIntersection3D",
		R"pbdoc(
			3-D box-ray intersection result (64-bit float).
		)pbdoc")
	.def_readwrite("isIntersecting", &BoundingBoxRayIntersection3D::isIntersecting,
		R"pbdoc(
			True if the box and ray intersects.
		)pbdoc")
	...
	pybind11::class_<BoundingBox3D>(static_cast<pybind11::handle>(m), "BoundingBox3D",
		R"pbdoc(
			3-D axis-aligned bounding box class (64-bit float).
		)pbdoc")
	.def("__init__", [](BoundingBox3D& instance, pybind11::args args)
	{
		if (args.size() == 2)
		{
			new (&instance) BoundingBox3D(ObjectToVector3D(args[0]), ObjectToVector3D(args[1]));
		}
		else if (args.size() == 0)
		{
	...
	.def("Overlaps", &BoundingBox3D::Overlaps,
		...
		pybind11::arg("other"))
	.def("Contains", [](const BoundingBox3D& instance, pybind11::object point)
	{
	...
	.def("Merge", [](BoundingBox3D& instance, pybind11::object other)
	{
		if (pybind11::isinstance<pybind11::tuple>(static_cast<pybind11::handle>(other)) ||
			pybind11::isinstance<Vector3D>(static_cast<pybind11::handle>(other)))
		{
			instance.Merge(ObjectToVector3D(other));
		}
		else if (pybind11::isinstance<BoundingBox3D>(static_cast<pybind11::handle>(other)))
		{
