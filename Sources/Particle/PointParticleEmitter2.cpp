/*************************************************************************
> File Name: PointParticleEmitter2.cpp
> Project Name: CubbyFlow
> Author: Chan-Ho Chris Ohk
> Purpose: 2-D point particle emitter.
> Created Time: 2017/07/22
> Copyright (c) 2017, Chan-Ho Chris Ohk
*************************************************************************/
#include <Matrix/Matrix2x2.h>
#include <Particle/PointParticleEmitter2.h>
...
namespace CubbyFlow
{
	...
	PointParticleEmitter2::Builder& PointParticleEmitter2::Builder::WithMaxNumberOfNewParticlesPerSecond(size_t maxNumOfNewParticlesPerSec)
	{
		m_maxNumberOfNewParticlesPerSecond = maxNumOfNewParticlesPerSec;
		return *this;
	}
